...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    solution: "Working primarily on retrofit projects, Positive Energy served as the EV charging specialist from the existing electrical distribution system through final charger commissioning.",
    servicesProvided: [
    ...
    resultsSignificance: "Lane Valente Industries served as the primary general contractor for much of this work. Repeated dealership deployments allowed Positive Energy to develop substantial experience working within active automotive facilities and adapting EV charging infrastructure to existing electrical systems.",
    projectImportance: "This program experience demonstrates repeatability across dozens of active dealership environments, multiple states, charger manufacturers, electrical conditions, and retrofit scenarios.",
    images: [
      {
        role: "hero",
        src: "",
